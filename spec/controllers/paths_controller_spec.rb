  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved path as @path" do
        ...
        allow_any_instance_of(Path).to receive(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested path" do
        ...
        expect_any_instance_of(Path).to receive(:update).with({ "name" => "MyText" })
        put :update, {:id => path.to_param, :path => { "name" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the path as @path" do
        path = Path.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Path).to receive(:update).and_return(false)
